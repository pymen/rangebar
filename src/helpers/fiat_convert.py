...
class CryptoToFiatConverter:
    ...
    def _get_gekko_id(self, crypto_symbol):
        ...
        if len(found) > 0:
            # Wrong!
            self.logger.warning(f"Found multiple mappings in CoinGecko for {crypto_symbol}.")
            return None
    ...
    def get_price(self, crypto_symbol: str, fiat_symbol: str) -> float:
        ...
        if crypto_symbol == 'usd':
            ...
            self.logger.info(f"reversing Rates {crypto_symbol}, {fiat_symbol}")
    ...
    def _find_price(self, crypto_symbol: str, fiat_symbol: str) -> float:
        ...
        try:
            ...
            self.logger.error("Error in _find_price: %s", exception)
            return 0.0
