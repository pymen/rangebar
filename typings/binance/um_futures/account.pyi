...
def query_order(self, symbol: str, orderId: int = ..., origClientOrderId: str = ..., **kwargs):
    """
    |
...
def cancel_order(self, symbol: str, orderId: int = ..., origClientOrderId: str = ..., **kwargs):
    """
    |
    | **Cancel Order (TRADE)**
...
def get_open_orders(self, symbol: str, orderId: int = ..., origClientOrderId: str = ..., **kwargs):
    """
    |
