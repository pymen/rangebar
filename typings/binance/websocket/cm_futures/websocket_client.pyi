...
class CMFuturesWebsocketClient(BinanceWebsocketClient):
    ...
    def index_price(self, pair: str, id: int, speed: int, callback, **kwargs): # -> None:
        """Index Price Streams
    ...
    def pair_mark_price(self, pair: str, id: int, speed: int, callback, **kwargs): # -> None:
    ...
    def index_kline(self, pair: str, id: int, interval: str, callback, **kwargs): # -> None:
    ...
    def mark_kline(self, symbol: str, id: int, interval: str, callback, **kwargs): # -> None:
        """Kline/Candlestick chart intervals Streams
